          ...
          <section id="step-route" className="order-section scroll-mt-20">
            ...
            <div className="relative grid lg:grid-cols-2 gap-6 lg:gap-12">
              ...
              <fieldset className="space-y-4 min-w-0">
                ...
                <div className="border border-[var(--color-ink)] bg-[var(--color-subtle)] p-3">
                  <Field label="Serviceable pickup location">
                    <select id="pickup-area" className="field mt-2 !bg-[var(--color-surface)]" required value={form.pickupAreaId} onChange={(e) => setForm({ ...form, pickupAreaId: e.target.value })}>
                  ...
                  {pickupArea && (
                    <div className="flex items-center justify-between gap-2 flex-wrap mt-3 pt-3 border-t border-[var(--color-rule)]">
                      <span className="status status-done">In network</span>
                      <Micro className="normal-case tracking-normal">{pickupArea.zoneName} · {pickupArea.pincode}</Micro>
                    </div>
                  )}
                </div>
                <Field label="Street / building / landmark">
                  <input id="pickup-address" className="field" required autoComplete="street-address" value={form.pickupLine1} onChange={(e) => setForm({ ...form, pickupLine1: e.target.value })} placeholder="Exact collection address" />
                </Field>
              </fieldset>
              ...
              <fieldset className="space-y-4 min-w-0">
                ...
                <div className="border border-[var(--color-ink)] bg-[var(--color-subtle)] p-3">
                  <Field label="Serviceable drop location">
                    <select id="drop-area" className="field mt-2 !bg-[var(--color-surface)]" required value={form.dropAreaId} onChange={(e) => setForm({ ...form, dropAreaId: e.target.value })}>
                  ...
                  {dropArea && (
                    <div className="flex items-center justify-between gap-2 flex-wrap mt-3 pt-3 border-t border-[var(--color-rule)]">
                      <span className="status status-done">In network</span>
                      <Micro className="normal-case tracking-normal">{dropArea.zoneName} · {dropArea.pincode}</Micro>
                    </div>
                  )}
                </div>
                <Field label="Street / building / landmark">
                  <input id="drop-address" className="field" required autoComplete="street-address" value={form.dropLine1} onChange={(e) => setForm({ ...form, dropLine1: e.target.value })} placeholder="Exact delivery address" />
                </Field>
              </fieldset>
            </div>
          </section>
